		...
		public override Sprite Create(BlockType type)
		{
			switch (type)
			{
                case BlockType.QuestionBlock:
                    return new AnimatedSprite(MarioCloneGame.GameContent.Load<Texture2D>("CustomSprites/SubBlocks"),
                        new Rectangle(0, 64, 64, 64), 2, 6, 6, 11, 6);
                case BlockType.BreakableBrick:
                    return new StaticSprite(MarioCloneGame.GameContent.Load<Texture2D>("CustomSprites/SubBlocks"),
